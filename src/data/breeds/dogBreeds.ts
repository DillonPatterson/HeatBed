...
export const dogBreeds: BreedProfile[] = [
  { id: 'chihuahua', label: 'Chihuahua', defaultWeightLb: 7, heatMultiplier: 0.72, spreadMultiplier: 0.74, lengthMultiplier: 0.58, widthMultiplier: 0.6, blurb: 'Tiny hotspot, surprisingly intense when tucked in.' },
  ...
  { id: 'husky', label: 'Husky', defaultWeightLb: 55, heatMultiplier: 1.05, spreadMultiplier: 1.2, lengthMultiplier: 1.08, widthMultiplier: 1.0, blurb: 'Insulated and fluffy, but less concentrated than a bulldog.' },
